 ...
 *
 * The inbox entry point and its unread badge were removed while inbox is not generally available:
 * the badge ran on every ProductList render, and on iOS the SDK ships no inbox, so it only logged
 * a rejection. `InboxScreen` is still registered in App.tsx for testing.
 */
