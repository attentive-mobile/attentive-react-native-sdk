 ...
 *   See the README "Android — Initialize from Native Code" section. Expo (CNG) apps get that
 *   native call generated by this package's Expo config plugin during `npx expo prebuild` —
 *   see the README "Expo apps — Config plugin (Android)" section.
 *
